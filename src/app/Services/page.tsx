...
export default function Services () {
  ...
  <div className=' flex flex-col pt-28 grid-cols-3 items-center space-y-3'>
      <h1 className={` animate-fade-down animate-once  text-5xl ${mont.className} font-serif font-black text-purple-800 tracking-widest  `} >Services Include</h1>
...
" image="/alvi.jpg"/> */}
<Card lnk=' ./Q1' title='Web Designing ' description=' Object-Oriented Programming using TypeScript ' image='/webd.png' />
<Card lnk=' ./Q2' title='Web Development' description=' Developing Planet Scale Web 2.O and Web Applications ' image='/webg.png' />
<Card lnk=' ./Q3' title='Graphic Designing ' description=' Full-Stack Templates and API Product Development ' image='/g.png' />
